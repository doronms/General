 ...
 *
 * This driver provides a standard TTY interface (/dev/ttyUL0) for
 * the Xilinx UARTLite IP core accessed via PCIe.
 *
 * Features:
...
#define UARTLITE_NR      4        /* Support up to 4 UARTs */
...
/*
 * Register access - use little-endian for PCIe/x86
 */
...
static int __init uartlite_init(void)
{
    ...
    pr_info("Xilinx UARTLite driver for PCIe bridge v2.0\n");
