...
/*
 * mcu_pcie.c - PCIe Bridge Driver for Xilinx FPGA with UARTLite
 *
 * This driver creates platform devices for FPGA peripherals including
 * Xilinx UARTLite. It handles MSI interrupts and provides an interrupt
 * notification mechanism for child drivers.
 *
 ...
 * Adjust offsets and sizes according to your FPGA design
 */
static const struct child_info children[] = {
    ...
    },
    {
        ...
        .offset = 0x70000,
        .size   = 0x1000,    /* UARTLite only needs 16 bytes, but give it more space */
        .needs_irq = true,
        .irq_idx   = 0,      /* User interrupt 0 */
    },
    { }  /* Terminator */
};
