...
#define P2PUART_VENDOR_ID       FPGA_VENDOR_ID
#define P2PUART_DEVICE_ID       FPGA_DEVICE_ID
...
/* Legacy names for compatibility */
#define PCIE_DEVICE_BASE_ADDRESS_OFFSET_VIDEO_MATRIX    0x60000
#define PCIE_DEFAULT_ADDRESS_RANGE      0x10000

/*
 * IRQ index assignments (matches children[] array in mcu_pcie.c)
 */
#define MCU_IRQ_IDX_UARTLITE_0  0
#define MCU_IRQ_IDX_UARTLITE_1  1
#define MCU_IRQ_IDX_UARTLITE_2  2
#define MCU_IRQ_IDX_UARTLITE_3  3
#define MCU_IRQ_IDX_UARTLITE_4  4
#define MCU_IRQ_IDX_UARTLITE_5  5
#define MCU_IRQ_IDX_UARTLITE_6  6
#define MCU_IRQ_IDX_UARTLITE_7  7
#define MCU_IRQ_IDX_UARTLITE_8  8
#define MCU_IRQ_IDX_UARTLITE_9  9
#define MCU_IRQ_IDX_UARTLITE_10 10
#define MCU_IRQ_IDX_UARTLITE_11 11
#define MCU_IRQ_IDX_TIMER1PPS   12
#define MCU_IRQ_IDX_TIMER1PPM   13
