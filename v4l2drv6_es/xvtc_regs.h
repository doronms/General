...
#ifndef XVTC_REGS_H_
#define XVTC_REGS_H_	/**< prevent circular inclusions
...
void xvtc_conv_timing2signal(XVtc_Timing* TimingPtr, XVtc_Signal* SignalCfgPtr, XVtc_HoriOffsets* HOffPtr, XVtc_Polarity* PolarityPtr);
...
int xcidc_get_video_stream(XVidC_VideoMode VmId, XVidC_ColorFormat ColorFormat, XVidC_ColorDepth Bpc,XVidC_PixelsPerClock Ppc, XVidC_VideoTiming* timing_out);
