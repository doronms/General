...
#else
int fzetta_fmc_gpio_init(void __iomem *BaseAddress, u8 Dev_ID)
#endif
{
	int Status;
	/*
	...
	Status = XGpio_Initialize(&fzetta_fmc_GpioOutput, Dev_ID, BaseAddress);
#endif
...
void fzetta_fmc_init_done(void) {
